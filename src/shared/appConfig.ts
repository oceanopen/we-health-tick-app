...
// appearance / work_*_time 为纯 UI 配置，后端不读，仅前端使用；
// language 由后端 i18n.rs（托盘菜单文案）读取，rest_window / long_break_window 由后端 panel.rs（窗口唤起）读取，
// 三者常量副本均在 shared/app_config.rs（timer.rs 11 项清单之外）。
